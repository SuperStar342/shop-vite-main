...
import org.springblade.core.mp.customize.MybatisPlusInterceptorCustomizer;
...
public class MybatisPlusConfiguration implements WebMvcConfigurer {
	...
	public MybatisPlusInterceptor mybatisPlusInterceptor(PaginationInnerInterceptor paginationInterceptor,
														 ...
														 MybatisPlusProperties mybatisPlusProperties,
														 ObjectProvider<MybatisPlusInterceptorCustomizer> customizerProvider) {
		...
		// 应用用户自定义拦截器逻辑
		customizerProvider.orderedStream().forEach(customizer -> customizer.customize(interceptor));
		return interceptor;
	}
